...
class LoginFresh extends StatefulWidget {
  static const id = 'LANDING_BUILD_SCREEN';
  ...
  ///custom_widgets.widget to put a footer in your login
  final bool isFooter;

  /// custom custom_widgets.widget footer
